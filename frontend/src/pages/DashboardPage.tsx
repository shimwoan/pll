    ...
    <Layout>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-[13px] text-gray-400 mt-0.5">Firm-wide performance and case activity</p>
        </div>
      ...
      <div className="flex items-stretch gap-3 mb-4">
        <div className="flex items-center gap-2.5 bg-red-50 border border-red-100 rounded-lg px-4 py-4 flex-1">
          ...
          <div>
            <div className="text-[13px] font-semibold text-red-700 uppercase tracking-wide leading-none mb-0.5">SOL Critical</div>
        ...
        <div className="flex items-center gap-2.5 bg-white border border-gray-100 rounded-lg px-4 py-4 flex-1">
          ...
          <div>
            <div className="text-[13px] font-medium text-gray-400 uppercase tracking-wide leading-none mb-0.5">Overdue Tasks</div>
        ...
        <div className="flex items-center gap-2.5 bg-white border border-gray-100 rounded-lg px-4 py-4 flex-1">
          ...
          <div>
            <div className="text-[13px] font-medium text-gray-400 uppercase tracking-wide leading-none mb-0.5">Email Queue</div>
            <div className="text-[13px] text-gray-800">
      ...
      <div className="grid grid-cols-4 gap-3 mb-4">
        {kpis.map(({ label, value, delta }) => (
          <div key={label} className="bg-white border border-gray-100 rounded-lg px-4 py-2.5">
            <div className="text-[13px] text-gray-400 mb-0.5 uppercase tracking-wide font-medium">{label}</div>
            <div className="text-xl font-semibold text-gray-800 leading-tight">{value}</div>
            <div className="text-[13px] text-gray-400 mt-0.5">{delta}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-5 gap-3 mb-4 items-stretch">
        <div className="col-span-2 bg-white border border-gray-100 rounded-lg p-4 flex flex-col">
          <div className="text-[15px] font-medium text-gray-700 mb-0.5">SOL Deadlines</div>
          <div className="text-[13px] text-gray-400 mb-2">Statute of limitations tracking</div>
            ...
            {solAlerts.map((item) => (
              <div key={item.caseNo} className="flex items-center justify-between py-1 border-b border-gray-50 last:border-0">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[13px] font-medium text-gray-700 leading-tight">{item.client}</div>
                    <div className="text-[13px] text-gray-400 leading-tight">{item.caseNo} · {item.type}</div>
                  </div>
                </div>
                <div className={`text-[13px] font-semibold tabular-nums ${solBadge[item.severity as keyof typeof solBadge]}`}>
                  {item.daysLeft}d
                </div>
              </div>
            ))}
        ...
        <div className="col-span-2 bg-white border border-gray-100 rounded-lg p-4">
          <div className="text-[15px] font-medium text-gray-700 mb-0.5">Case Pipeline</div>
          <div className="text-[13px] text-gray-400 mb-2">Active cases by stage</div>
        ...
        <div className="col-span-1 bg-white border border-gray-100 rounded-lg p-4 flex flex-col">
          <div className="text-[15px] font-medium text-gray-700 mb-0.5">CM Workload</div>
          <div className="text-[13px] text-gray-400 mb-2">Active · Overdue</div>
      ...
      <div className="grid grid-cols-5 gap-3">
        <div className="col-span-4 bg-white border border-gray-100 rounded-lg p-4">
          <div className="text-[15px] font-medium text-gray-700 mb-0.5">Settlement Trend</div>
          <div className="text-[13px] text-gray-400 mb-2">Monthly closed settlement amount</div>
        ...
        <div className="col-span-1 bg-white border border-gray-100 rounded-lg p-4">
          <div className="text-[15px] font-medium text-gray-700 mb-0.5">Recent Activity</div>
          <div className="text-[13px] text-gray-400 mb-3">Latest events</div>
          <div className="space-y-2.5">
            {recentActivity.map((item, i) => (
              <div key={i} className="flex flex-col gap-0.5">
                <div className="flex items-center justify-between">
                  <span className="text-[13px] font-medium text-gray-700 leading-tight">{item.event}</span>
                  <span className="text-[13px] text-gray-300 shrink-0 ml-1">{item.time}</span>
                </div>
                <span className="text-[13px] text-gray-400 truncate leading-tight">{item.detail}</span>
              </div>
            ))}
          </div>
        </div>
