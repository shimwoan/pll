...
async function main() {
    await prisma.case.createMany({
        data: [
            { caseNumber: 'PI251201', claimNumbers: ['SF-2024-8821'], clientName: 'Robert Johnson', handler: 'John Doe', stage: 'Intake', dateOfLoss: new Date('2025-12-15'), dueDate: new Date('2026-12-15') },
            ...
            { caseNumber: 'PI260107', claimNumbers: ['AA-2025-9900'], clientName: 'Angela Nguyen', handler: 'John Doe', stage: 'Intake', dateOfLoss: new Date('2026-01-22'), dueDate: new Date('2028-01-22') },
